...
describe PeopleController do
  ...
  describe "GET show" do
    it "assigns the requested person as @person" do
      Person.stub(:get).with("37") { mock_person }
      get :show, :id => "37"
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested person" do
        Person.should_receive(:get).with("37") { mock_person }
        mock_person.should_receive(:update).with({'these' => 'params'})
        put :update, :id => "37", :person => {'these' => 'params'}
      end

      it "assigns the requested person as @person" do
        Person.stub(:get) { mock_person(:update => true) }
        put :update, :id => "1"
        assigns(:person).should be(mock_person)
      end
    ...
    describe "with invalid params" do
      it "assigns the person as @person" do
        Person.stub(:get) { mock_person(:update => false) }
        put :update, :id => "1"
        assigns(:person).should be(mock_person)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the people list" do
      Person.stub(:get) { mock_person(:destroy => true) }
      delete :destroy, :id => "1"
